...
# 피타고라스 정리 [^cut-the-knot] {#pythagoras-theorem}

[^cut-the-knot]: [Cut the Knot, "Pythagorean Theorem"](http://www.cut-the-knot.org/pythagoras/)
...
<iframe src="https://www.geogebra.org/calculator/dwcqzryj?embed" width="800" height="600" allowfullscreen style="border: 1px solid #e4e4e4;border-radius: 4px;" frameborder="0"></iframe>

## 곱셈 {#rulers-multiplication}

삼각형을 이용한 곱셈과 나눗셈은 다음과 같다.

1. 한변의 길이가 1인 삼각형을 그린다.
1. 다른 한변과 평행한 선을 갖는 삼각형을 쭉 늘린다.
1. 삼각형의 성질을 이용하여 다음과 같이 $x$를 구할 수 있다.

$$\frac{p}{1} = \frac{x}{q}$$
$$x = p \times q$$

<iframe src="https://www.geogebra.org/calculator/rnkmqr5p?embed" width="800" height="600" allowfullscreen style="border: 1px solid #e4e4e4;border-radius: 4px;" frameborder="0"></iframe>


## 제곱근 {#rulers-square-roots}

자와 콤파스를 이용하여 제곱근도 구할 수 있다.

1. 길이 1을 갖는 직선을 그린다.
1. $p$ 까지 길이를 늘린다.
1. $p$까지 늘린 반지름을 갖는 반원을 그린다.
1. 길이 1인 직선에서 직각을 이루는 선분을 반원에 닿는 곳까지 연결하고 연결하여 삼각형을 완성한다.

$$\frac{1}{x} = \frac{x}{p}$$
$$x = \sqrt{p}$$

<iframe src="https://www.geogebra.org/calculator/bncpwxhj?embed" width="800" height="600" allowfullscreen style="border: 1px solid #e4e4e4;border-radius: 4px;" frameborder="0"></iframe>
